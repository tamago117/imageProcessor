...
{
    ros::NodeHandle pnh("~");
    pnh.param<int>("minH", minH, 0);
    pnh.param<int>("maxH", maxH, 255);
    pnh.param<int>("minS", minS, 0);
    pnh.param<int>("maxS", maxH, 255);
    pnh.param<int>("minV", minV, 0);
    pnh.param<int>("maxV", maxV, 255);
